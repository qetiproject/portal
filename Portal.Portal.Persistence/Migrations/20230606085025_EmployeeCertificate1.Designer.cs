...
namespace Portal.Portal.Persistence.Migrations
{
    ...
    [Migration("20230606085025_EmployeeCertificate1")]
    partial class EmployeeCertificate1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Portal.Application.AdminPanelModule.Models.ContractType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.AdminPanelModule.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.AdminPanelModule.Models.TimeOffRequestPanel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HRWhoReceivesTimeOffRequests")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Portal.Portal.Application.EmployeeServiceModule.Models.ChildModels.PayrollBasic", b =>
                {
                    ...
                    b.Property<int?>("ParticipationInPension")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.NonComplianceModule.Models.ChildModels.NonComplianceFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NonComplianceFile");
                });

            modelBuilder.Entity("Portal.Portal.Application.NonComplianceModule.Models.ChildModels.NonComplianceRedirect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NonComplianceRedirect");
                });

            modelBuilder.Entity("Portal.Portal.Application.NonComplianceModule.Models.NonCompliance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ViolatorComment")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ViolatorFileId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ViolatorFileId");

                    b.ToTable("NonCompliances");
                });

            modelBuilder.Entity("Portal.Portal.Application.RolesModule.Models.ChildModels.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.RolesModule.Models.ChildModels.PermissionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.RolesModule.Models.ChildModels.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.RolesModule.Models.ChildModels.RoleUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Portal.Application.EmployeeServiceModule.Models.ChildModels.EmployeeTraining", b =>
                {
                    b.HasOne("Portal.Portal.Application.EmployeeServiceModule.Models.ChildModels.EmployeeFile", "Certificate")
                        .WithMany()
            ...
            modelBuilder.Entity("Portal.Portal.Application.EmployeeServiceModule.Models.ChildModels.JobInfo", b =>
                {
                    b.HasOne("Portal.Portal.Application.EmployeeServiceModule.Models.ChildModels.EmployeeFile", "IdDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("Portal.Portal.Application.NonComplianceModule.Models.ChildModels.NonComplianceRedirect", b =>
                {
                    b.HasOne("Portal.Portal.Application.NonComplianceModule.Models.ChildModels.NonComplianceFile", "File")
                        .WithMany()
                        .HasForeignKey("FileId");

                    b.HasOne("Portal.Portal.Application.NonComplianceModule.Models.NonCompliance", null)
                        .WithMany("Redirects")
            ...
            modelBuilder.Entity("Portal.Portal.Application.NonComplianceModule.Models.NonCompliance", b =>
                {
                    ...
                    b.HasOne("Portal.Portal.Application.NonComplianceModule.Models.ChildModels.NonComplianceFile", "StatusFile")
                        .WithMany()
                        .HasForeignKey("StatusFileId");

                    b.HasOne("Portal.Portal.Application.NonComplianceModule.Models.ChildModels.NonComplianceFile", "ViolatorFile")
                        .WithMany()
                        .HasForeignKey("ViolatorFileId");

                    b.Navigation("File");

                    b.Navigation("StatusFile");

                    b.Navigation("ViolatorFile");
                });

            modelBuilder.Entity("Portal.Portal.Application.RolesModule.Models.ChildModels.Permission", b =>
                {
                    b.HasOne("Portal.Portal.Application.RolesModule.Models.ChildModels.PermissionGroup", null)
