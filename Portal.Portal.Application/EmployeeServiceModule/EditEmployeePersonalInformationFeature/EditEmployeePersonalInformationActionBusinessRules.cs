...
{
    public class EditEmployeePersonalInformationActionBusinessRules : AbstractValidator<EditEmployeePersonalInformationAction>
    {
        public EditEmployeePersonalInformationActionBusinessRules()
        {
